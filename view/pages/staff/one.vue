<template>
	<view>
		<u-cell-group>
			<u-cell-item class="" :value='user.username' :valueStyle='valueStyle'
				:title-style="titleStyle" :arrow='false'>
				<u-image width='120rpx' height='120rpx' slot="title" :src="user.faceurl" shape="circle" @click='changeHead'></u-image>
			</u-cell-item>
