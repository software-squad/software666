<template>
	<view>
		<u-field v-model="item.loginname" label="登录名" placeholder="请输入用户登录名" label-align="center" >
		</u-field>
		<!-- <u-gap height="10" bg-color="#f9f9f9"></u-gap> -->
		<u-field v-model="item.newpwd" label="重置密码" placeholder="请输入重置密码" label-align="center" :password="true">
		</u-field>
